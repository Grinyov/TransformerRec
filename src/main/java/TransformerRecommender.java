 ...
 *
 *
 * Класс преобразовывает файл ratings.dat из формата GroupLens в формате CSV
 * создает класс модели, который будет обрабатывать рейтинги
    из CSV-файл и создает простой Рекомендатель на этой модели.
 И извлекает рекомендации содержащиеся в данных ratings.csv
